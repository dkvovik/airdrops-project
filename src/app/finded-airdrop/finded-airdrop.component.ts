...
export class FindedAirdropComponent implements OnInit {
  ...
  openModalWithComponent(airdrop) {
    ...
    initialState['requirementsIcon'] = ['Twitter', 'Github', 'Google-plus'];
  ...
  template: `
    ...
    <div class="modal-subheader-detail">
      <div class="subheader-detail-item">
        <span class="badge_grey">Asset ID</span>{{assetId}}
        <span class="badge_grey">Platform</span>{{platform}}
      </div>
      <div class="subheader-detail-item">
        <div class="requirements-wrapper" >
          <span class="badge_grey">Requirements</span>
          <span [ngSwitch]="requirement | lowercase" *ngFor="let requirement of requirementsIcon"
                [popover]="requirement" triggers="mouseenter:mouseleave" class="requirement-item">
